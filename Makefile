...
test: all
	...
	@echo "Test compression with LZW..."
	@./$(TARGET) -c --comp-alg lzw -i test_data/test1.txt -o test_data/test1.lzw -v
	@echo "Test decompression with LZW..."
	@./$(TARGET) -d --comp-alg lzw -i test_data/test1.lzw -o test_data/test1_lzw_restored.txt -v
	@echo "Test encryption with AES..."
	@./$(TARGET) -e --enc-alg aes128 -i test_data/test1.txt -o test_data/test1.enc -k "testkey123" -v
	@echo "Test decryption with AES..."
	...
	@echo "Test encryption with Salsa20..."
	@./$(TARGET) -e --enc-alg salsa20 -i test_data/test1.txt -o test_data/test1.salsa.enc -k "testkey123" -v
	@echo "Test decryption with Salsa20..."
	@./$(TARGET) -u --enc-alg salsa20 -i test_data/test1.salsa.enc -o test_data/test1_salsa_decrypted.txt -k "testkey123" -v
	@echo "Test encryption with RC4..."
	@./$(TARGET) -e --enc-alg rc4 -i test_data/test1.txt -o test_data/test1.rc4.enc -k "testkey123" -v
	@echo "Test decryption with RC4..."
	@./$(TARGET) -u --enc-alg rc4 -i test_data/test1.rc4.enc -o test_data/test1_rc4_decrypted.txt -k "testkey123" -v
	@echo "Test combined operations (LZ77+AES)..."
	...
	@echo "Test combined operations (Huffman+ChaCha20)..."
	...
	@echo "Test combined operations (LZW+RC4)..."
	@./$(TARGET) -ce --comp-alg lzw --enc-alg rc4 -i test_data/test2.txt -o test_data/test2.lzw.rc4.enc -k "secret" -v
	@./$(TARGET) -du --enc-alg rc4 --comp-alg lzw -i test_data/test2.lzw.rc4.enc -o test_data/test2_lzw_rc4_restored.txt -k "secret" -v
	...
	@diff test_data/test1.txt test_data/test1_lzw_restored.txt && echo "✓ LZW compression test passed" || echo "✗ LZW compression test failed"
	...
	@diff test_data/test1.txt test_data/test1_salsa_decrypted.txt && echo "✓ Salsa20 encryption test passed" || echo "✗ Salsa20 encryption test failed"
	@diff test_data/test1.txt test_data/test1_rc4_decrypted.txt && echo "✓ RC4 encryption test passed" || echo "✗ RC4 encryption test failed"
	...
	@diff test_data/test2.txt test_data/test2_lzw_rc4_restored.txt && echo "✓ Combined operations (LZW+RC4) test passed" || echo "✗ Combined operations test failed"
